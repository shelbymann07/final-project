...
/*function type(d) {
    ...
    d["violent_rate"] = +d["violent_rate"];
    d["murder_manslaughter_rate"] = +d["murder_manslaughter_rate"];
    d["robbery_rate"] = +d["robbery_rate"];
    d["assault_rate"] = +d["assault_rate"];
  return d;
}*/
...
d3.tsv("data/crime_multi.tsv", function(error, data) {
